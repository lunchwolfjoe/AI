...
const seriesParts = [
  {
    part: 1,
    title: "The Promise",
    subtitle: "Texas Built the Bridge",
  ...
  },
  {
    part: 2,
    title: "The Connector",
    subtitle: "Arun Agarwal",
    description: "He is not the scandal. He is the design — a person whose value is the ability to move between institutions that appear separate.",
    slug: "the-connector",
  },
  {
    part: 3,
  ...
  },
  {
    part: 5,
    title: "The Network",
    subtitle: "ITServe Alliance",
    description: "Educate. Lobby. Litigate. How a fragmented industry learned to act collectively — and why Texas still sees them as vendors.",
  ...
  },
  {
    ...
    description: "Texas promised taxpayer-funded jobs to Texans. Its contractor system still cannot show who performs much of the work.",
    slug: "the-ledger",
  },
];
