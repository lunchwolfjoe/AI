    ...
    <div className="bg-white">
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <header className="mb-12">
          <p className="label-caps text-[#8b0000] mb-4">How We Work</p>
        ...
        <div className="prose-editorial">
          ...
          <p>
            ...
            agency documents — receive strong weight. <strong>Contemporaneous reporting</strong> — 
            news accounts from the time quoting principals — serves as corroboration. 
            <strong>Secondary analysis</strong> — later compilations and third-party databases — 
            generates leads but does not prove claims.
          </p>

          <h2>What Each Record Type Proves</h2>
          <p>
            We are deliberate about not over-interpreting evidence. Each record type 
          ...
          <h2>How We Connect Records</h2>
          <p>
            We join records across entities and time using verified identifiers — not 
          ...
          <p>
            When names are ambiguous — multiple "John Smiths," for instance — we hold 
            the connection as a lead rather than a confirmed match unless corroborating 
            evidence establishes identity.
          </p>

          <h2>We Correct Ourselves</h2>
          <p>
            Several early theories were weakened or changed by later records. We document 
          ...
          <ul>
            ...
            <li>TxEDC does not administer the Texas Enterprise Fund — we initially overstated this</li>
          ...
          <p>
            We do not characterize silence as confirmation. A nonresponse is reported 
            as exactly that.
          </p>
        </div>
